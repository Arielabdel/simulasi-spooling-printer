...
while (queue.length > 0 && printing) {
    ...
    printing = false;
    log('Printer memasuki mode idle. Silakan reset atau tambahkan dokumen baru untuk memulai print <3');
};

pauseBtn.onclick = () => {
    paused = !paused;
    log(paused ? 'Printer dijeda. Silakan klik tombol jeda lagi untuk melanjutkan.' : 'Printer dilanjutkan.');
};
